...
class SaleOrderImportationTemplateDataSequence(models.Model):
    ...
    data_id = fields.Many2one('lexora.so.import.template.data', string="Data", default = lambda self: self.env.ref('return_report.lexora_sale_order_importation_template_data_pass_column'))
