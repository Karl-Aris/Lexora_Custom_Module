...
class SaleOrderImportation(models.TransientModel):
    ...
    def upload_notify(self, recordsets, invalid_data):
        ...
        action = self.env.ref('return_report.action_sale_order_upload_result_form')
        return {
    ...
    def start_upload(self):
        ...
        if mode == 'xlsx' and not self.template_id: # for xls  
            ...
            mode_header_conversion = {x : (self.env.ref('return_report.%s' % y).id, z) for x,y,z in mode_header_base}
